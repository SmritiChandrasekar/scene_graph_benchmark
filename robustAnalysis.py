...
models = ["e2e_faster_rcnn_X_101_32x8d_FPN_1x_caffe2.yaml","e2e_faster_rcnn_R_101_FPN_1x_caffe2.yaml","e2e_faster_rcnn_R_50_C4_1x_caffe2.yaml","e2e_mask_rcnn_X_101_32x8d_FPN_1x_caffe2.yaml","e2e_mask_rcnn_R_101_FPN_1x_caffe2.yaml","e2e_mask_rcnn_R_50_C4_1x_caffe2.yaml"]
...
transformations = ["_horizontal_flip_image.jpg", "_vertical_flip_image.jpg", "_guassian_noise_image.jpg","_median_noise_image.jpg"
,"_grey_scale_image.jpg"]

for model in models:
    print("executing for model:")
    print(model)
    model = "caffe2/" + model
    exec_obj_detection(model)

    f = open('detection_output/detection_output_'+ os.path.splitext(os.path.split(model)[1])[0]  +'.json')
    ...
    for img_file in original_list:
        ...
        text_save_file = 'metrics_comparison/metrics_comparison_'+ os.path.splitext(os.path.split(model)[1])[0] +'.json'
